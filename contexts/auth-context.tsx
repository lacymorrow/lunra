...
import { getUserProfileClient, getUserSubscriptionClient } from "@/lib/services/subscriptions-client"
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const [userSubscription, setUserSubscription] = useState<DatabaseSubscription | null>(null)
